...
class ArvoreBinaria {
    NoArvoreBinaria raiz;     // Raiz da árvore
    ...
    private NoArvoreBinaria inserirRec(NoArvoreBinaria no, int valor) {
    ...
    private void preOrdem(NoArvoreBinaria no) {
        if (no != null) {
    ...
    private void posOrdem(NoArvoreBinaria no) {
        if (no != null) {
    ...
    private NoArvoreBinaria removerMaiorRec(NoArvoreBinaria no) {
        if (no == null) {
            return no;
        }
    ...
    private NoArvoreBinaria removerMenorRec(NoArvoreBinaria no) {
        if (no == null) {
            return no;
        }
    ...
    private NoArvoreBinaria removerRec(NoArvoreBinaria no, int valor) {
        if (no == null) {
            return no;
        }
        ...
        if (valor < no.dado) {
            ...
            no.dado = valorMinimo(no.direita);
    ...
    private int valorMinimo(NoArvoreBinaria no) {
        int valorMinimo = no.dado;
        while (no.esquerda != null) {
            valorMinimo = no.esquerda.dado;
            no = no.esquerda;
        }
        return valorMinimo;
    }
